                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="color:#032F51; font-size:medium;font-family:Bodoni MT Black">
                                            ...
                                            ?>
                                            <a class="btn btn-success" href="./administrar_talleres_agregar_foto.php?id=<?php echo ($d["ID_TALLER"]) ?>&u=<?php echo ($_SESSION["user"]) ?>&p=<?php echo ($_SESSION["ID"]) ?>&n=<?php echo $d['NOMBRE'] ?>" style="width:230px ;">AGREGAR NUEVA FOTO</a>
                                            <br><br>
