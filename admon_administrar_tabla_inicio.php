...
<?php
    ...
    $k = new key();
    include_once("./Modelo/TablaInicio/Consultar_tabla_inicio.php");
    $obj_inicio = new Consultar_tabla_inicio();
    $datos_inicio = $obj_inicio->selectTablaInicio();
?>
    <div class="card text-center" style="height:100%; position:relative;left:0%">
        <br>
        <div class="card-body">
            <a href="./admon_administrar_tabla_inicio_registrar.php" class="btn btn-success" style="width: 60%;">Crear nuevo dato para la tabla de inicio</a>
            <br><br>
            <div class="card">
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger" onClick="return confirm('Confirmar eliminación')" href="./Controlador/eliminar_tabla_inicio.php?id=<?php echo ($datos["ID"]) ?>&u=<?php echo $k->enc($_SESSION["admin_ecotec"]) ?>" style="width:210px ;">ELIMINAR</a>
                                            </td>
                                        </tr>
                                <?php
