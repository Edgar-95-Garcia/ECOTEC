...
?>
    ...
    <div class="card text-center" style="height:100%; position:relative;left:0%">
        ...
        <div class="card-body">
            <div class="card">
                <h5 class="card-header">PROFESORES REGISTRADOS EN SISTEMA</h5>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="./admon_administrar_profesores_modificar.php?id=<?php echo ($profesor["ID_USUARIO"]) ?>&u=<?php echo $k->enc($_SESSION["admin_ecotec"]) ?>" style="width:210px ;">MODIFICAR</a>
                                            <br><br>
                                            <a class="btn btn-danger" onClick="return confirm('Confirmar eliminación')" href="./Controlador/eliminar_profesor.php?id=<?php echo ($profesor["ID_USUARIO"]) ?>&u=<?php echo $k->enc($_SESSION["admin_ecotec"]) ?>" style="width:210px ;">ELIMINAR</a>
