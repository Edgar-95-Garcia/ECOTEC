...
?>
    ...
    */
    ...
    if ($_SESSION["admin_ecotec"] == $sesion) {
        include_once("../Modelo/TablaEcoride/Borrar_tabla_inicio_ecoride.php");
        $obj_usuario = new Borrar_tabla_inicio_ecoride();
    ...
    ?>
        <script>
            document.location.replace("../admon_administrar_tabla_inicio_ecoride.php");
        </script>
    <?php
    } else {
    ?>
