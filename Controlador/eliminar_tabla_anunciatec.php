...
?>
    ...
    */
    ...
    if ($_SESSION["admin_ecotec"] == $sesion) {
        include_once("../Modelo/TablaAnunciaTec/Borrar_tabla_inicio_anunciatec.php");
        $obj_usuario = new Borrar_tabla_inicio_anunciatec();
    ...
    ?>
        <script>
            document.location.replace("../admon_administrar_tabla_inicio_anunciatec.php");
        </script>
    <?php
    } else {
    ?>
