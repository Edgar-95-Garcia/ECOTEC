...
?>
    <div class="card text-center" style="height:100%; position:relative;left:0%">
        <br>
        <div class="card-body">
            <a href="./admon_administrar_noticias_registrar_panel.php" class="btn btn-success" style="width: 60%;">Agregar nueva imagen</a>
            <br><br>
            <div class="card">
                <h5 class="card-header">IMAGENES QUE SE MUESTRAN EN EL PANEL DEL INICIO </h5>
                <div class="card-body">
                    <div style="overflow-x: auto; white-space: nowrap;">
                        <table class="table table-hover" border="2px" style="table-layout:auto; ">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <th colspan="4"><i>NO HAY IMAGENES REGISTRADAS</i> </th>
                                    </tr>
                                    <?php
                                } else {
